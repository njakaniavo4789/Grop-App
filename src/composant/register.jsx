...
export default function AgricultureAISignup() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (agreedToTerms && password === confirmPassword) {
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-6 relative">
          ...
          <div className="relative w-full max-w-lg">
            ...
            <div className="relative bg-[#0d1612]/40 backdrop-blur-2xl border border-green-500/10 rounded-3xl p-5 md:p-7 shadow-2xl shadow-green-500/5">
              ...
              <div className="grid grid-cols-2 gap-2.5 mb-3 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                <button className="py-2.5 px-3 bg-green-950/20 border border-green-500/10 rounded-xl hover:border-green-500/30 hover:bg-green-950/30 transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm group">
                  ...
                  <span className="text-green-400/60 group-hover:text-green-400 text-xs font-medium transition-colors">Google</span>
                </button>
                <button className="py-2.5 px-3 bg-green-950/20 border border-green-500/10 rounded-xl hover:border-green-500/30 hover:bg-green-950/30 transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm group">
                  <svg className="w-4 h-4" fill="#1877F2" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  <span className="text-green-400/60 group-hover:text-green-400 text-xs font-medium transition-colors">Facebook</span>
                </button>
              </div>
              ...
              <div className="flex items-center gap-3 my-3">
                ...
                <span className="text-green-400/40 text-[10px] font-medium tracking-wider">OU AVEC EMAIL</span>
                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-green-500/20 to-transparent" />
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-2.5 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                ...
                <button
                  type="submit"
                  className="relative w-full py-3 mt-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-xl overflow-hidden group shadow-lg shadow-green-500/20 hover:shadow-green-500/40 transition-all duration-300"
                >
