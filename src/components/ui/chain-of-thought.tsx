...
export const ChainOfThoughtItem = ({
  ...
  <div className={cn("text-sm", className)} style={{ color: "var(--text-muted)" }} {...props}>
    {children}
  </div>
)
...
export const ChainOfThoughtTrigger = ({
  ...
  <CollapsibleTrigger
    className={cn(
      "group flex cursor-pointer items-center justify-start gap-1 text-left text-sm transition-colors",
      className
    )}
...
export const ChainOfThoughtContent = ({
  ...
  <CollapsibleContent
    ...
    {...props}
  >
    <div style={{ display: "grid", gridTemplateColumns: "min-content minmax(0, 1fr)", columnGap: 16 }}>
      {/* Vertical connector line — visible on non-last steps */}
      <div
        className="group-data-[last=true]:invisible"
        style={{
          marginLeft: 7,
          width: 1,
          height: "100%",
...
export const ChainOfThoughtStep = ({
  ...
  <Collapsible className={cn("group", className)} data-last={isLast || undefined} {...props}>
    {children}
    {/* Vertical connector line below trigger — hidden on last step */}
    {!isLast && (
